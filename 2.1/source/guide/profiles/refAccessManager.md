...
* Full Access - The device's System Settings Menu will not be reduced
* Reduced Access - The device's System Settings menu will be reduced to a pre-selected group of options (Display, Volume, About)
...
<table>
	...
	<tr>
		<td rowspan="7">Single User with Whitelist</td>
		<td>Full Access</td>
		<td>X</td>
		<td>X</td>
		<td>X</td>
