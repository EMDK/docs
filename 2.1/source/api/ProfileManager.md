...
>Note: extraData as a Document type is currently only supported for DataCapture profile features.
...
>Note: extraData as a ProfileConfig type is currently only supported for DataCapture profile features.
